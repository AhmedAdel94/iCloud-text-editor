...
class DocumentBrowserViewController: UIDocumentBrowserViewController, UIDocumentBrowserViewControllerDelegate,UIViewControllerTransitioningDelegate {
    ...
    var transiotionContoller : UIDocumentBrowserTransitionController?
    ...
    func presentDocument(at documentURL: URL) {
        ...
        transiotionContoller = transitionController(forDocumentAt: documentURL)
        transiotionContoller?.targetView = documentViewController.textView
        
        present(navController, animated: true, completion: nil)
    }
    
    func animationController(forPresented presented: UIViewController, presenting: UIViewController, source: UIViewController) -> UIViewControllerAnimatedTransitioning? {
        return transiotionContoller
    }
